...
<body>
	...
	<c:forEach var="producers" items="${cart_in}">
	${producers.producer_idx}<br>
	</c:forEach>
				...
				<div class="card" style="width: 425px;">
							...
							<div class="card-body product">
								<table style="width: 100%;">
									...
									<tr>
										...
										<td style="text-align: right;" class="price">${cart.product_price}</td>
									</tr>
									<tr>
										<td colspan="4"><hr></td>
									</tr>
					...
					<div class="card-body">
						<table style="width: 100%;">
							<tr>
								<td>상품금액</td>
								<td class="totPrice" style="text-align: right;"></td>
							</tr>
							<tr>
								<td>배송비</td>
								<td class="deliveryFee" style="text-align: right;"></td>
							</tr>
							<tr>
								<td>총 금액</td>
								<td class="totCost" style="text-align: right;"></td>
							</tr>
						</table>
					</div>
				</div>
