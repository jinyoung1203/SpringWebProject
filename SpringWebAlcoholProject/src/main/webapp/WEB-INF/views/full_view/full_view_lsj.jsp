...
<body>
	...
	<header id="header" class="header d-flex align-items-center">
		...
		<div
			...
			<a href="main.do" class="logo d-flex align-items-center"> <!-- Uncomment the line below if you also wish to use an image logo -->
				...
				<ul>
					...
					<li class="nav-item dropdown"><c:if test="${user1 ne null}">
							...
							<ul class="dropdown-menu dropdown-menu-arrow profile">
								<li><a class="dropdown-item" href="#"> <span>My
											Profile</span>
								</a></li>
								<li>
									<hr class="dropdown-divider">
								...
								<li><a class="dropdown-item d-flex align-items-center"
									href="#"> <span>Account Settings</span>
								</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
								<li><a class="dropdown-item d-flex align-items-center"
									href="logout.do"> <span>Sign Out</span>
								</a></li>
